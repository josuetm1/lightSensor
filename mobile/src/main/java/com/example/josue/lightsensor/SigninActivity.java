...
public class SigninActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNombresView = (EditText) findViewById(R.id.nombres);
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            mAuthTask = new UserLoginTask(nombres, apellidos, email, password);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        UserLoginTask(String name, String apellido, String email, String password) {
            mEmail = email;
            mPassword = password;
            mName = name;
            mApellido = apellido;
        ...
        protected Boolean doInBackground(Void... params) {
            if (AzureDataBase.getInstace().user_exist(mEmail)){
                return false;
            }
            return AzureDataBase.getInstace().save_user(mName,mApellido,mEmail,mPassword);
        }
